 ...
 **/
router.post("/:username/jobs/:jobId", ensureLoggedIn, ensureAdminOrCorrectUser, async function (req, res, next){
  try {
    const jobApp = await User.apply(req.params.username, req.params.jobId);
